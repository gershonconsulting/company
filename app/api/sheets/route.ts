...
export async function GET(req: Request) {
  ...
  const lines = [
    ...
    `${origin}/api/sheets/duedate/count               -> leads with an active follow-up (incomplete task or due date)`,
    `${origin}/api/sheets/overdue/count              -> leads with at least one overdue task`,
